...
?>
             ...
             ';
                                  ...
                                  Rp <?php  echo number_format($result->PRODISPRICE); ?>
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td> Rp<output id="Osubtot<?php echo $result->PROID ?>"><?php echo number_format($_SESSION['gcCart'][$i]['price']); ?></output></td>
                                </tr>
                        ...
                        <h3  align="right"> Total  Rp <span id="sum" ></span>0</h3> 
    </div>
  </div>  
