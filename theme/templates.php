          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +62 823 0132 2821</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> myglasess@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>my</span>glasses</h2>
              <p>"A simile is like a pair of eyeglasses, one side sees this, one side sees that, the device brings them together." ~ George McWhirter</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
