...
(/** @lends <global> */function( $ ) {
	...
	var _api_registeRp.lural; // DataTable.Api.registeRp.lural
	 ...
	 * for their Hungarian counteRp.arts. The mapping is stored in a private
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		if ( oOptions !== undefined && oOptions !== null )
		{
			...
			// Map camel case parameters to their Hungarian counteRp.arts
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		_fnCallbackFire( oSettings, 'aoServeRp.arams', 'serveRp.arams', [data] );
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			_fnCallbackReg( oSettings, 'aoServeRp.arams',       oInit.fnServeRp.arams,      'user' );
	...
	_Api.registeRp.lural = _api_registeRp.lural = function ( pluralName, singularName, val ) {
	...
	_api_registeRp.lural( 'tables().nodes()', 'table().node()' , function () {
	...
	_api_registeRp.lural( 'tables().body()', 'table().body()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTBody;
		} );
	} );
	...
	_api_registeRp.lural( 'tables().header()', 'table().header()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTHead;
		} );
	} );
	...
	_api_registeRp.lural( 'tables().footer()', 'table().footer()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTFoot;
		} );
	} );
	...
	_api_registeRp.lural( 'rows().cache()', 'row().cache()', function ( type ) {
		return this.iterator( 'row', function ( settings, row ) {
	...
	_api_registeRp.lural( 'rows().invalidate()', 'row().invalidate()', function ( src ) {
		return this.iterator( 'row', function ( settings, row ) {
			_fnInvalidateRow( settings, row, src );
		} );
	} );
	
	_api_registeRp.lural( 'rows().indexes()', 'row().index()', function () {
		return this.iterator( 'row', function ( settings, row ) {
			return row;
		} );
	} );
	
	_api_registeRp.lural( 'rows().remove()', 'row().remove()', function () {
		var that = this;
	 ...
	 *
	 */
	_api_registeRp.lural( 'columns().header()', 'column().header()', function ( selector, opts ) {
	 ...
	 *
	 */
	_api_registeRp.lural( 'columns().footer()', 'column().footer()', function ( selector, opts ) {
		return this.iterator( 'column', function ( settings, column ) {
	 ...
	 *
	 */
	_api_registeRp.lural( 'columns().data()', 'column().data()', function () {
	...
	_api_registeRp.lural( 'columns().cache()', 'column().cache()', function ( type ) {
		return this.iterator( 'column-rows', function ( settings, column, i, j, rows ) {
	...
	_api_registeRp.lural( 'columns().nodes()', 'column().nodes()', function () {
		return this.iterator( 'column-rows', function ( settings, column, i, j, rows ) {
	...
	_api_registeRp.lural( 'columns().visible()', 'column().visible()', function ( vis ) {
		return this.iterator( 'column', function ( settings, column ) {
	...
	_api_registeRp.lural( 'columns().indexes()', 'column().index()', function ( type ) {
		return this.iterator( 'column', function ( settings, column ) {
			return type === 'visible' ?
	...
	_api_registeRp.lural( 'cells().nodes()', 'cell().node()', function () {
	...
	_api_registeRp.lural( 'cells().cache()', 'cell().cache()', function ( type ) {
	...
	_api_registeRp.lural( 'cells().indexes()', 'cell().index()', function () {
		return this.iterator( 'cell', function ( settings, row, column ) {
			return {
				row: row,
				column: column,
	...
	DataTable.models.oSearch = {
		...
		/**
		 * Flag to indicate if the search term should be inteRp.reted as a
	...
	DataTable.defaults = {
		 ...
		 *   not return anything from the function. This supersedes `fnServeRp.arams`
		 *   from DataTables 1.9-.
		 *
		 ...
		 *  @dtopt Callbacks
		 *  @dtopt Server-side
		 *  @name DataTable.defaults.serveRp.arams
		 *
		 *  @deprecated 1.10. Please use `ajax` for this functionality now.
		 */
		"fnServeRp.arams": null,
